...
External API data — sentiment via Adanos, fundamental research and raw data via Funda AI (MCP + REST), Fintel short-interest/ownership intelligence, Hormuz Strait monitoring, TradingView desktop app reading, and Hyperliquid perp/spot reading.
